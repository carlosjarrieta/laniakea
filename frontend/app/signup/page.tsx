      ...
      <Card className="w-full max-w-[1000px] overflow-hidden border-none shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] z-10 flex flex-col md:flex-row bg-white">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-14 flex flex-col justify-center bg-white">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <Button 
              type="submit" 
              className="w-full h-11 bg-violet-600 hover:bg-violet-700 text-white font-bold text-lg rounded-xl shadow-[0_8px_30px_rgb(139,92,246,0.3)] transition-all active:scale-[0.98] mt-4"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
            ...
            <Button 
              variant="outline" 
              type="button" 
              className="w-full h-11 border-zinc-200 text-zinc-600 hover:bg-zinc-50 font-bold rounded-xl transition-all flex gap-2"
            >
